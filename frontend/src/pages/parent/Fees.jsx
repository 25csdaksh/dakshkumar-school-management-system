...
import StudentFees from '../student/Fees.jsx';
...
export const Fees = () => {
  ...
  if (loading) return <div>Syncing billing databases...</div>;
  ...
  return (
    <div>
      ...
      <StudentFees studentId={selectedChildId} />
    </div>
  );
};
